...
namespace VariablesAndOperators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Types of shirt to be purchased
            Console.WriteLine("How many Superswim, cost are $15 each");
            int totalSuperswim = int.Parse(Console.ReadLine());
            
            Console.WriteLine("How many Be the Shark, cost are $17.50 each");
            int totalShark = int.Parse(Console.ReadLine());

            Console.WriteLine("How many Baby Bubbles, cost are $4.75 each");
            int totalBubbles = int.Parse(Console.ReadLine());




            
            //Subtotal = using mulitpication and addition
